...
/// @param enviromnent the environment to hold the object
/// @param object the object to be looked up
/// @param header_location pointer to the location to place the hedaer if such exists
/// @return true if object exists in environment
...
/// @param header pointer to the location where the removed header will be placed
